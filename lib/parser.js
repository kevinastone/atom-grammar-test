...
class Header /* :: <T> implements HeaderType */ {
  /* ::
  scope: string;
  openToken: string;
  closeToken: string;
...
class Parser {
  ...
  * _iterate() /* : Iterable<Line> */ {
  ...
  // $FlowFixMe: can't handle computed property
  * [Symbol.iterator]() {
    yield* this._iterate();
  }
}
...
export interface HeaderIterator extends Iterable<Line> {
  header: HeaderType;
}
*/

export function parse(iterator /* : LineIterator */) /* : HeaderIterator */ {
